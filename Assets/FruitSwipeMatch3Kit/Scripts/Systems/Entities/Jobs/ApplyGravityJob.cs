            ...
            int pSide = 1;
               for (var i = 0; i >= 0; i+=pSide)
               {
                ...
                for (var j = Height - 1; j >= 0; j--)
                {
                    ...
                    Ecb.SetComponent(Tiles[pResultFind.x], new TilePosition
                    {
                    ...
                    Ecb.SetComponent(Tiles[pResultFind.x], new Translation
                    {
                        Value =
                        {
            ...
            if (tileSelf == Entity.Null)
            {
                for (int row = posY ; row >= 0; --row)
                {
                                                      ...
                                                      BlockerData[tile].Type != BlockerType.Wood3))
                    {
                        ...
                        if (pResultLeft.x != -1 && pResultLeft.y < pResultRight.y)
                        {
